module.exports = {
  ...
  myPositionNote: 'Get the current location, provide location-related functions and attract nearby users\' interest and more attention to you, and select your group from many groups to join. You can set whether to allow the location acquisition function, or go to "System Settings" to change the authorization of Tweebaa.',
  ...
  leaveAndAppointNew: "Leave and Appoint New Host",
  speakButton: "Join the Discussion",
  ...
  tagGroups: 'Groups',
  tagNft: 'NFTs',
  tagFlash: 'Flash Rewards',
  tagCallAction: 'Calls for Actions',
  tagDao: 'DAO Votings',
  tagMix: 'MixChats',
  tagMeet: 'Meetings',
  tagSpot: 'Spotlights',
  tagGroupNote: 'Group Notes',
  tagReadyTransfer: 'ReadyTransfers',
  tagValueGifts: 'Value Gifts',
