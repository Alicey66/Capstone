module.exports = {
  trackrewarddist: "Track the distribution of rewards and view the progress of certain rewards with restrictions",
  tbeanreward: "Get T-Beans Rewards",
  digitalproductreward: "Get digital product rewards",
  participantcompletedtask: "Participants who completed the task and received the reward",
  hourstoend: "hours",
  remaining: "Remaining",
  completionprogress: "Depending on the completion progress, participants can be contacted directly to help them complete the task while also helping you promote",
  ...
  Paymentcompletion: "Payment Status",
  Pending: "Pending",
